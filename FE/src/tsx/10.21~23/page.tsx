  ...
  return (
    <div className={style.positiveBody}>
      ...
      <div className={style.contentsBody}>
        ...
        <button className={style.modify}>권한 수정하기</button>
      </div>
      {/* 클릭 시 부모의 상태를 true로 변경 */}
      <div className={style.expel} onClick={onExpelClick}>강제탈퇴</div>
    </div>
  )
}
    ...
    <div className={style.dropOverlay}> {/* 화면 전체를 덮는 어두운 배경 */}
      <div className={style.dropContainer}>
        <div className={style.dropText}>
          정말 <strong>{name}</strong>님을<br/>강제탈퇴 시키시겠습니까?
        </div>
