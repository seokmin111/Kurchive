    ...
    <div className={styles.restaurantCard}>
      <div className={styles.cardContent}>
        ...
        <div className={styles.uploader}>
          ...
          <div>
            <div className={styles.uploader_name}>올린 사람 이름</div>
            <div className={styles.uploader_date}>Date</div>
          </div>
        </div>
      </div>
      <div
      ...
      >
        ...
        {restaurant.hasImage && restaurant.photoCount && (
          <span className={styles.imageOverlay}>사진 +{restaurant.photoCount}개</span>
        )}
      </div>
    </div>
  );
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.pageTitle}>
        <span className={styles.username}>{username}</span> 의 레시피 아카이브
      </div>
